...
int hminWhite = 0, hmaxWhite = 359, sminWhite = 0, smaxWhite = 30, vminWhite = 150, vmaxWhite = 250;
...
int main()
{
    //string path = ("C:/Users/Utilisateur/Pictures/image.jpg");
    ...
    while (true)
    {
        ...
        imshow("img1", maskYel);
        imshow("img2", maskBlue);
        imshow("img3", maskRed);
        imshow("img4", maskGreen);
        imshow("img5", maskWhite);
